...
def admin_dashboard(request: Request):
    ...
    revenue = {"MRR": "Not measured", "Active Subscription": metrics["revenue"]["Active Subscription"], "Trial Conversion": "Not measured"}
    ...
    product_cards = {
        "Completed signup events": product["counts"]["Signup"],
        "Onboarding starts": product["counts"]["Onboarding Started"],
        "Onboarding completions": product["counts"]["Onboarding Completed"],
        "Wizard starts": product["counts"]["Export Wizard Started"],
        "Wizard completions": product["counts"]["Export Wizard Completed"],
        "Invoices created": product["counts"]["Invoice Created"],
        "Email sent events": product["counts"]["Email Sent"],
    }
    visitor_cards = {"Recorded page views": visitors["visits"], "Landing page views": visitors["pages"]["Landing"], "Signup page views": visitors["pages"]["Signup"]}
